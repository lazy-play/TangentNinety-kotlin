...
public class PhotoView extends ImageView {
    ...
    public void setLoadImageSuccessListener(LoadImageSuccessListener listener) {
        this.listener = listener;
    }

    private LoadImageSuccessListener listener;
    private boolean hasFrame=false;
    private boolean hasImage=false;
    protected void loadImageSuccess(){
        if(hasFrame&&hasImage&&listener!=null){
